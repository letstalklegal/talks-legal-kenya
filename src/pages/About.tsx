          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-accent pl-6 py-2">
                  <div className="flex items-start gap-3 mb-1">
                    ...
                    <div className="flex-1">
                      <h3 className="font-serif font-bold text-primary text-lg">Current Role</h3>
                      <p className="text-foreground font-semibold">Associate Advocate</p>
                      <p className="text-muted-foreground text-sm">Maina & Onsare Partners Advocates LLP (since 19 May 2022)</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-l-4 border-accent pl-6 py-2">
                  <div className="flex items-start gap-3 mb-1">
                    ...
                    <div className="flex-1">
                      <h3 className="font-serif font-bold text-primary text-lg">Certification</h3>
                ...
                <div className="border-l-4 border-accent pl-6 py-2">
                  <div className="flex items-start gap-3 mb-1">
                    ...
                    <div className="flex-1">
                      <h3 className="font-serif font-bold text-primary text-lg">Specialization</h3>
                      <p className="text-foreground font-semibold">Employment & Labour Law</p>
                      <p className="text-muted-foreground text-sm">With mediation and dispute resolution expertise</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative flex justify-center">
              ...
              <div className="relative w-full max-w-md">
                <img
                  src={karimiAbout}
                  alt="Ashley Karimi Chege, Advocate of the High Court of Kenya"
                  className="w-full h-auto rounded-2xl shadow-2xl border-4 border-white/20"
                  loading="lazy"
                />
                <div className="absolute -bottom-6 -right-6 bg-accent text-primary rounded-xl p-4 shadow-lg font-serif font-bold text-center max-w-xs">
                  <p className="text-sm font-semibold">Advocate of the High Court</p>
                  <p className="text-xs text-primary/80">Employment Law Specialist</p>
                </div>
              </div>
            </div>
          </div>
